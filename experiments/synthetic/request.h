...
#ifndef GHOST_EXPERIMENTS_SYNTHETIC_REQUEST_H_
#define GHOST_EXPERIMENTS_SYNTHETIC_REQUEST_H_
...
// A synthetic request generated by 'Ingress'.
struct Request {
    // A fast request.
    struct Get;
    ...
    static absl::Duration GetExponentialHandleTime(absl::BitGen &gen,
        ...
        // In the exponential distribution Exp('lambda'), the expected value
        // (i.e., the mean) is equal to '1 / lambda'. Thus, we need to pass '1 /
        // mean_ns' as 'lambda' to the exponential distribution to have a mean
        // sample value of 'mean_ns'.
...
#endif // GHOST_EXPERIMENTS_SYNTHETIC_REQUEST_H_

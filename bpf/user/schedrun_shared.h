...
#ifndef GHOST_LIB_BPF_SCHEDRUN_SHARED_H_
#define GHOST_LIB_BPF_SCHEDRUN_SHARED_H_

// Keep this file's structs in sync with bpf/schedrun_shared_bpf.h.
...
#endif  // GHOST_LIB_BPF_SCHEDRUN_SHARED_H_

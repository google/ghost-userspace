...
#ifndef GHOST_LIB_BPF_SCHEDRUN_SHARED_BPF_H_
#define GHOST_LIB_BPF_SCHEDRUN_SHARED_BPF_H_

// Keep this file's structs in sync with bpf/schedrun_shared.h.
...
#endif  // GHOST_LIB_BPF_SCHEDRUN_SHARED_BPF_H_
